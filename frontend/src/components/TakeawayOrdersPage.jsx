...
const TakeawayOrdersPage = () => {
  ...
  const fetchOrders = async () => {
    try {
      ...
      const res = await axios.get("https://goldenpluscaferms.onrender.com/api/auth/cashier/takeaway-orders", {
  ...
  const submitDeliveryUpdate = async () => {
    try {
      ...
      const res = await axios.put(
        `https://goldenpluscaferms.onrender.com/api/auth/order/${editingOrderId}/delivery-status`,
        editData,
        {
          headers: {
