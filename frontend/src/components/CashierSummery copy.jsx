...
const CashierSummary = () => {
  ...
  const fetchOtherIncomes = async () => {
    try {
      const res = await axios.get(
        `https://goldenpluscaferms.onrender.com/api/auth/income/other/by-date?date=${dateFilter}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const fetchOtherExpenses = async () => {
    try {
      const res = await axios.get(
        `https://goldenpluscaferms.onrender.com/api/auth/expense/other/by-date?date=${dateFilter}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const fetchForwardBalance = async (currentDate) => {
    try {
      ...
      const res = await axios.get(
        `https://goldenpluscaferms.onrender.com/api/auth/cashier/shift-summary/${yesterdayStr}`,
        {
          headers: { Authorization: `Bearer ${token}` }
        }
      );
  ...
  const checkExistingSummary = async () => {
    try {
      const res = await axios.get(
        `https://goldenpluscaferms.onrender.com/api/auth/cashier/shift-summary/${dateFilter}`,
        {
          headers: { Authorization: `Bearer ${token}` }
        }
      );
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://goldenpluscaferms.onrender.com/api/auth/cashier/shift-summary/submitshift",
        payload,
        {
          headers: { Authorization: `Bearer ${token}` }
        }
