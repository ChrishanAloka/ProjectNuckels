...
const ResetPassword = () => {
  ...
  const handleVerifyKey = async () => {
    try {
      await axios.post("https://goldenpluscaferms.onrender.com/api/auth/verify-reset-key", { key });
      setStep(2);
    } catch (err) {
  ...
  const handleResetPassword = async () => {
    try {
      await axios.post("https://goldenpluscaferms.onrender.com/api/auth/reset-password", { email, key, newPassword });
